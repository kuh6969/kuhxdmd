...
phoneNumber: 'https://youtube.com/c/KukuhRamadhann'
}
}, {
quickReplyButton: {
...
case 'smeme': case 'stickermeme': case 'stickmeme': {
  ...
  memek = await neoxy.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
  ...
  atas = arg.split('|')[0]
  bawah = arg.split('|')[1]
  let abeb = await neoxy.downloadAndSaveMediaMessage(quoted)
  let abe = await TelegraPh(abeb)
  let upz = `https://api.memegen.link/images/custom/${atas}/${bawah}.png?background=${util.format(abe)}`
  let mengmeme = await neoxy.sendImageAsSticker(m.chat, upz, m, { packname: global.packname, author: global.author })
